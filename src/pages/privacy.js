...
const Privacy = () => (
  <Layout>
    ...
    <div className="page-headers privacy_image">
      <h3>Privacy Policy</h3>
    </div>

    <div className="pages-body-container">
      <strong>Last updated: April 13, 2020</strong>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to HoloAsh, Inc., 2035
            Sunset Lake Road, Suite B-2, Newark.
          </p>
          <p>
        ...
        <li>
          ...
          the Company downloaded by You on any electronic device, named weBelong
        </li>{" "}
        <li>
        ...
        <li>
          <strong>Website</strong> refers to weBelong, accessible from
          https://webelong.app
        </li>{" "}
        <li>
      ...
      <p>
        ...
        of mobile Internet browser You use, unique device identifiers, other
        diagnostic data, and communication data.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            <a href="https://www.appnexus.com/platform-privacy-policy#choices">
          ...
          <p>
            ...
            <a href="https://www.appnexus.com/platform-privacy-policy">
      ...
      <div className="policy--middle--p__container">
        <p>Privacy Policy </p>
        <p>Copyright© 2021 HoloAsh,Inc. All rights reserved</p>
      </div>
    </div>
  </Layout>
)

...
const Terms = () => (
  <Layout>
    ...
    <div className="pages-body-container">
      <p className="terms--p__notice">
        Please read these Terms of Use (“Terms”, “Terms of Use”) carefully
        before using the <a href="http://webelong.app">https://webelong.app</a>{" "}
        website and the weBelong mobile application (the “Service”) operated by
        HoloAsh, Inc. (“us”, “we”, or “our”). Your access to and use of the
      ...
      <p>
        ...
        ("Content"). You are responsible for your use of the Services and for
        any Content you provide, including compliance with applicable laws,
        rules, and regulations. You should only provide Content that you are
        comfortable sharing with others. Any use or reliance on any Content or
        materials posted via the Services or obtained by you through the
        Services is at your own risk. We do not endorse, support, represent or
        guarantee the completeness, truthfulness, accuracy, or reliability of
        any Content or communications posted via the Services or endorse any
        ...
        Services and, we cannot take responsibility for such Content. We reserve
        the right to remove Content that violates the User Agreement, including
        for example, copyright or trademark violations, impersonation, unlawful
        conduct, or harassment. Information regarding specific policies and the
        process for reporting or appealing violations can be found in our Help
        Contact:
        <p></p>
        <a
      ...
      <h2>Your Right in the Content</h2>
      <p>
        ...
        your incorporated audio, photos and videos are considered part of the
        Content). By submitting, posting or displaying Content on or through the
        ...
        includes the right for weBelong to provide, promote, and improve the
        ...
        for such Content use. Such additional uses by us, or other companies,
